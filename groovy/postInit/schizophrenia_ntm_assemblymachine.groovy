...
mods.hbm.assemblyMachine.recipeBuilder()
    ...
    .input(ore('plateSteel') * 4, item('appliedenergistics2:material', 10) * 4, item('hbm:circuit', 8), ore('wireFineLead') * 8)
...
mods.hbm.assemblyMachine.recipeBuilder()
    ...
    .input(ore('plateSteel') * 4, item('appliedenergistics2:material', 10) * 4, item('hbm:circuit', 9), ore('wireFineLead') * 8, ore('ingotAnyResistantAlloy'))
...
mods.hbm.assemblyMachine.recipeBuilder()
    ...
    .input(ore('plateSteel') * 4, item('appliedenergistics2:material', 10) * 4, item('hbm:circuit', 11), ore('wireFineLead') * 8, ore('ingotAnyResistantAlloy') * 2)
...
mods.hbm.assemblyMachine.recipeBuilder()
    ...
    .input(ore('plateSteel') * 4, item('appliedenergistics2:material', 10) * 4, item('hbm:circuit', 15), ore('wireFineLead') * 8, ore('ingotAnyResistantAlloy') * 4)
...
mods.hbm.assemblyMachine.recipeBuilder()
    ...
    .input(ore('plateSteel') * 4, item('appliedenergistics2:material', 9), item('hbm:circuit', 8), ore('wireFineLead') * 8)
    .output(item('appliedenergistics2:material', 32))
    .duration(200)
    .power(100)
    .register()
...
mods.hbm.assemblyMachine.recipeBuilder()
    ...
    .input(ore('plateSteel') * 4, item('appliedenergistics2:material', 9), item('hbm:circuit', 9), ore('wireFineLead') * 8, ore('ingotAnyResistantAlloy'))
    .output(item('appliedenergistics2:material', 33))
    .duration(200)
    .power(100)
    .register()
...
mods.hbm.assemblyMachine.recipeBuilder()
    ...
    .input(ore('plateSteel') * 4, item('appliedenergistics2:material', 9), item('hbm:circuit', 11), ore('wireFineLead') * 8, ore('ingotAnyResistantAlloy') * 2)
    .output(item('appliedenergistics2:material', 34))
    .duration(200)
    .power(100)
    .register()
