...
mods.hbm.arcWelder.recipeBuilder()
    .input(item('appliedenergistics2:material', 32), item('appliedenergistics2:material', 39))
    .output(item('appliedenergistics2:spatial_storage_cell_2_cubed'))
    .duration(100)
    .power(2000)
    .register()

mods.hbm.arcWelder.recipeBuilder()
    .input(item('appliedenergistics2:material', 33), item('appliedenergistics2:material', 39))
    .output(item('appliedenergistics2:spatial_storage_cell_16_cubed'))
    .duration(300)
    .power(10000)
    .register()

mods.hbm.arcWelder.recipeBuilder()
    .input(item('appliedenergistics2:material', 34), item('appliedenergistics2:material', 39))
    .output(item('appliedenergistics2:spatial_storage_cell_128_cubed'))
    .duration(400)
    .power(500000)
    .register()
