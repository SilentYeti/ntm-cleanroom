...
// NOTE: the NTM machine recipes for this AE2 progression (Assembly Machine,
// Arc Welder, Soldering, Chemical Plant) used to live at the tail of this
// file. They've been split out into one file per machine:
//   groovy/postInit/schizophrenia_ntm_assemblymachine.groovy
//   groovy/postInit/schizophrenia_ntm_arcwelder.groovy
//   groovy/postInit/schizophrenia_ntm_soldering.groovy
//   groovy/postInit/schizophrenia_ntm_chemicalplant.groovy
// See those files for hbm's mods.hbm.recipeOverrides.override(target, json)
// mechanism and the "exactly one script may own a given target" rule.
